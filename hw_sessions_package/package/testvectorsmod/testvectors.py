...
# E = helpers.getRandomInt(8)
# M = helpers.getModulus(1024)
# C, RN, R2N = HW.MontExp_MontPowerLadder(X, E, M)  # 解构返回的三个值
# D = helpers.Modexp(X, E, M)
# e = C - D
...
# print("E                = ", hex(E))           # 8-bits
# print("M                = ", hex(M))           # 1024-bits
# print("RN               = ", hex(RN))          # 1024-bits
# print("R2N              = ", hex(R2N))         # 1024-bits
# print("(X^E) mod M      = ", hex(C))           # 1024-bits
# print("(X^E) mod M (ref)= ", hex(D))           # 1024-bits
# print("error            = ", hex(e))

X = helpers.getRandomInt(1024)
E = helpers.getRandomInt(8)  # 为了减少输出量，可以使用较小的 E
M = helpers.getModulus(1024)
C, RN, R2N = HW.MontExp_MontPowerLadder(X, E, M)
D = helpers.Modexp(X, E, M)
e = C - D
